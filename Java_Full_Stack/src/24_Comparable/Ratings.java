/*
Ratings
A website uses the Rating class to store information about ratings of publications. It has two integer fields:
upVotes and downVotes , and implements the Comparable interface. Your task is to write its compareTo method.
Two Rating objects must be compared by a "net rating" which is calculated as a difference between the number
...
class Rating implements Comparable<Rating> {
    ...
    public int compareTo(Rating rating) {
        ...
        return thisNetRating -  otherNetRating;
    }
}
